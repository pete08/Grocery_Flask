...
def home():
    ...
    itemspaginated = Item.query.filter(Item.user_id.in_(userstruelist_userids)).paginate(page=page, per_page=2)
    ...
    return render_template('home.html', items=itemspaginated, users_ids=userstruelist_userids, items_public=items_public)
